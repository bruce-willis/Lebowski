...
import com.yury.lebowski.repository.convertToUniversal

fun calculateBalanceAfterOperations(start_balance: Double, operations: List<Record>): Double {
    return start_balance + operations.sumByDouble { it.operationType.Effect() * it.amount * it.currencyType.convertToUniversal() }
}